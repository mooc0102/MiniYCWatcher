...
#define FILE_SYSTEM_EVENT_REAL_DELETE   5
#define FILE_SYSTEM_EVENT_OVERWRITE   6
...
#define MINIYCWATCHER_MAJ_VERSION 2
#define MINIYCWATCHER_MIN_VERSION 0

typedef struct _MINIYCWATCHERVER {

    USHORT Major;
    USHORT Minor;

} MINIYCWATCHERVER, *PMINIYCWATCHERVER;

//
//  Name of minispy's communication server port
//

#define MINIYCWATCHER_PORT_NAME                   L"\\MiniYCWatcherPort"
...
typedef struct _YC_STREAM_CONTEXT {

    BOOLEAN                     DeleteOnClose;
    BOOLEAN                     Overwrite;

} YC_STREAM_CONTEXT, *PYC_STREAM_CONTEXT;
...
typedef enum _MINIYCWATCHER_COMMAND {
